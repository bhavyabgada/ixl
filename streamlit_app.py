...
def send_meal_plan_email(email, meal_plan):
    """Send the meal plan via email with beautiful HTML formatting"""
    try:
        ...
        <body>
            ...
            <div class="footer">
                ...
                <p>This email was generated by your Nutritional Assistant</p>
            </div>
        </body>
        </html>
        """
...
if prompt := st.chat_input("Ask me about nutrition, recipes, or meal planning..."):
    ...
    try:
        ...
        if "meal plan" in prompt.lower() and st.session_state.user_preferences["email"]:
            send_meal_plan_email(st.session_state.user_preferences["email"], response_text)
    except Exception as e:
